...
object GradlePluginId {
    const val GRADLE_KOTLIN_PLUGIN = "org.jetbrains.kotlin:kotlin-gradle-plugin:${GradlePluginVersion.KOTLIN}"
    ...
    const val ANDROID_EXTENSION = "kotlin-android-extensions"
