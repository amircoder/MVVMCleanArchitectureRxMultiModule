...
val SOME_LOCAL_SEARCH_MODEL = LocalSearchModel(
    id = SOME_ID,
    type = SOME_TYPE,
    status = SOME_STATUS,
    officialSite = SOME_URL,
...
val SOME_LOCAL_OTHER_SEARCH_MODEL = LocalSearchModel(
    id = SOME_OTHER_ID,
    type = SOME_OTHER_TYPE,
    status = SOME_OTHER_STATUS,
    officialSite = SOME_OTHER_URL,
...
@JvmField
val SOME_SEARCH_MODELS: List<SearchModel> = Collections.singletonList(SOME_SEARCH_MODEL)
@JvmField
val SOME_OTHER_SEARCH_MODELS: MutableList<SearchModel> = Collections.singletonList(SOME_OTHER_SEARCH_MODEL)
@JvmField
val SOME_LOCAL_SEARCH_MODELS: MutableList<LocalSearchModel> = Collections.singletonList(SOME_LOCAL_SEARCH_MODEL)
@JvmField
val SOME_OTHER_LOCAL_SEARCH_MODELS: MutableList<LocalSearchModel> = Collections.singletonList(SOME_LOCAL_OTHER_SEARCH_MODEL)
